...
export default function HelloBankPage() {
  ...
  const [newDepense, setNewDepense] = useState({ 
    ...
    compteDestination: 'aucun' as 'bred' | 'sumeria' | 'benoit' | 'marine' | 'aucun'
  })
                  ...
                  <div className="space-y-3">
                    ...
                    {editDepenseData.type === 'virement_recurrent' && (
                      <select
                        ...
                        onChange={(e) => setEditDepenseData({ ...editDepenseData, compteDestination: e.target.value as 'bred' | 'sumeria' | 'benoit' | 'marine' | 'aucun' })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                      >
            ...
            <div className="space-y-3">
              ...
              {newDepense.type === 'virement_recurrent' && (
                <select
                  ...
                  onChange={(e) => setNewDepense({ ...newDepense, compteDestination: e.target.value as 'bred' | 'sumeria' | 'benoit' | 'marine' | 'aucun' })}
